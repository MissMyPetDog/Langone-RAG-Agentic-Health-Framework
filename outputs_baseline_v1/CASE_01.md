...
What evidence-based treatment options are recommended for a 46-year-old female patient with acute kidney injury (AKI) onset in the ICU, considering her comorbidities of severe liver disease, mild liver disease, malignancy, and coagulopathy, along with current use of diuretics and antibiotics and maintaining close monitoring of renal and hepatic function?
...
The management of acute kidney injury (AKI) in critically ill patients, especially with comorbidities such as severe liver disease, malignancy, and coagulopathy, requires careful consideration of both renal and hepatic function. The literature provides several recommendations to optimize treatment while mitigating risks.

1. **Discontinue Nephrotoxic Agents**: The primary step in managing AKI is to discontinue all nephrotoxic drugs when possible, as continued use can exacerbate kidney damage. This is crucial given the patient's existing conditions and current use of diuretics and antibiotics, which can contribute to nephrotoxicity [KDOQI US commentary (pmid_23499048_p12)].

2. **Ensure Volume Status and Perfusion Pressure**: Maintaining proper fluid balance and perfusion pressure is recommended to support renal function. Functional hemodynamic monitoring can help in managing fluid levels accurately, which is vital given potential complications from liver disease and coagulopathy [KDOQI US commentary (pmid_23499048_p12)]. This involves careful balance to avoid both fluid overload and dehydration.

3. **Consider Renal Replacement Therapy (RRT)**: For patients who do not respond to conservative measures or progress to severe AKI, RRT such as dialysis may be necessary. This is particularly pertinent for those with severe liver disease and coagulopathy where metabolic waste product accumulation can become life-threatening [KDOQI US commentary (pmid_23499048_p12)]. Decision-making should take into account the patient's overall prognosis, including malignancy.

Fallback logic: If discontinuation of nephrotoxic agents is not feasible due to the lack of alternatives, ensuring optimal volume status becomes even more critical. If these measures do not stabilize kidney function, and AKI progresses, RRT may be the last viable option.

### References

- *KDOQI US commentary on the 2012 KDIGO clinical practice guideline for acute kidney injury* (pmid_23499048_p12): Recommended discontinuation of nephrotoxic agents, ensuring perfusion pressure, RRT consideration.
...
|------|-------|----------|--------|-----------------|
| 1 | 0.8094 | `pmid_23499048_p12_t0_c0` | `pmid_23499048` | `pmid_23499048_p12` |
| 2 | 0.6997 | `pmid_23499048_p7_t0_c0` | `pmid_23499048` | `pmid_23499048_p7` |
| 3 | 0.6861 | `pmid_23499048_p6_t0_c0` | `pmid_23499048` | `pmid_23499048_p6` |
| 4 | 0.6706 | `pmid_23499048_p5_t1_c0` | `pmid_23499048` | `pmid_23499048_p5` |
| 5 | 0.6296 | `pmid_23499048_p7_t0_c1` | `pmid_23499048` | `pmid_23499048_p7` |
