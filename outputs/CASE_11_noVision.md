...
In a 73-year-old Black female patient with acute kidney injury onset and underlying conditions including congestive heart failure, chronic kidney disease, and severe diabetes, who experiences a serum creatinine increase from 0.90 to 1.40 mg/dL and is currently on nephrotoxic agents, diuretics, antibiotics, and anticoagulants, what are the evidence-based recommendations for managing AKI considering contraindications such as current nephrotoxic medication use and comorbid conditions?
...
Managing acute kidney injury (AKI) in the context of prior nephrotoxic agent use and multiple comorbidities such as congestive heart failure, chronic kidney disease (CKD), and severe diabetes in an elderly patient demands careful consideration of interventions aimed at stabilizing renal function while minimizing further nephrotoxicity risks.

1. **Isotonic Crystalloids for Fluid Management**: Given the patient's cardiac status and the acute kidney injury onset, the KDIGO guidelines suggest using isotonic crystalloids (rather than colloids like albumin or starches) for intravascular volume expansion in patients at risk for or experiencing AKI [KDOQI US commentary on the 2012 KDIGO clinical practice guideline for acute kidney injury (pmid_23499048_p11)]. While managing fluid balance is crucial due to heart failure, crystalloids can avoid exacerbating cardiac overload, a concern with colloids.

2. **Evaluate and Manage Nephrotoxic Exposure**: It is essential to evaluate all current medications that could be contributing to nephrotoxicity. Strategies should include reviewing and minimizing nephrotoxic agents such as certain antibiotics and diuretics where feasible, according to patient tolerance and necessity [KDOQI US commentary on the 2012 KDIGO clinical practice guideline for acute kidney injury (pmid_23499048_p3)]. Given her renal injury, adjusting or suspending medications, if possible, is critical to reduce further damage, with close monitoring of creatinine and urine output.

3. **Vasopressor Therapy**: If there is evidence of vasomotor shock, vasopressors may be used along with fluid resuscitation to maintain hemodynamic stability, as per KDIGO recommendations [KDOQI US commentary on the 2012 KDIGO clinical practice guideline for acute kidney injury (pmid_23499048_p11)]. Vasopressors must be carefully calibrated in patients with congestive heart failure to avoid exacerbating cardiac conditions.

The sequential consideration of these options depends on the feasibility regarding the patient's cardiac and renal tolerance. If isotonic crystalloids pose risks due to potential fluid overload, reducing nephrotoxic exposure becomes the priority. If nephrotoxic adjustment is insufficient and hemodynamic instability exists, vasopressor therapy can be considered as a preventive measure or treatment adjunct.

### References

- **KDOQI US commentary on the 2012 KDIGO clinical practice guideline for acute kidney injury (pmid_23499048_p11)**: Supported the use of isotonic crystalloids for fluid management in AKI.
- **KDOQI US commentary on the 2012 KDIGO clinical practice guideline for acute kidney injury (pmid_23499048_p3)**: Provided insight into management strategies including minimization of nephrotoxic agents.
